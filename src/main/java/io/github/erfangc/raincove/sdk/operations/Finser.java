...
import io.github.erfangc.raincove.sdk.models.CreateCompanyRequest;
...
import io.github.erfangc.raincove.sdk.models.CreateFinancialStatementsResponse;
...
import io.github.erfangc.raincove.sdk.models.CreateCompanyResponse;

public interface Finser {

    @RequestLine("POST /companies")
    @Headers({"Content-Type: application/json", "Accept: application/json"})
    CreateCompanyResponse createOrUpdateCompany(CreateCompanyRequest body);
    ...
    @Headers({"Content-Type: application/json", "Accept: application/json"})
    CreateFinancialStatementsResponse createOrUpdateFinancialStatements(CreateFinancialStatementsRequest body, @Param("companyId") String companyId);
